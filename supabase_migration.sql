...
-- Purpose: Migrates an existing Supabase database from the legacy schema
--          (e.g., profiles.id, cycles.start_date, cycles.end_date)
--          to the canonical menomate-core schema.
-- Note: FOR BRAND-NEW SUPABASE PROJECTS, EXECUTE supabase_initial_schema.sql INSTEAD.
--       This file is a template intended for updating an existing database.
-- =============================================================================
